...
def main() -> int:
    ...
    result = {
        ...
        "apply_cursor": geometry(page.debug_cursor_apply_button),
        "cursor_row": geometry(page.debug_cursor_apply_button.master),
    }
    first_required = (
    ...
    result["apply_cursor_fits"] = (
        result["apply_cursor"]["requested"] <= result["cursor_row"]["actual"]
    )
